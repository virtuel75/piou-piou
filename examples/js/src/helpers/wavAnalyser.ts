...
export class WavAnalyser {
    ...
    public static analyseFile = (filename: string) => {
        ...
        const chunkSizeBytes: number[] = bytes.slice(4, 8)
        ...
        const subChunk1SizeBytes: number[] = bytes.slice(16, 20)
        ...
        const audioFormatBytes: number[] = bytes.slice(20, 22)
        ...
        const channelNumberBytes: number[] = bytes.slice(22, 24)
        ...
        const sampleRateBytes: number[] = bytes.slice(24, 28)
        ...
        const byteRateBytes: number[] = bytes.slice(28, 32)
        ...
        const bitsPerSampleBytes: number[] = bytes.slice(34, 36)
        ...
        const subChunk2SizeBytes: number[] = bytes.slice(40, 44)
